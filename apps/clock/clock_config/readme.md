...
| ---------- | ---------------- |--------- |
|  [PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/dm320007)  | PA14 (Pin #7 on the J12 connector)  | LED1 |
||||
