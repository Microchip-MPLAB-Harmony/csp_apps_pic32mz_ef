...
This example application demonstrates how to use different low power modes of the device. It allows user to put the device in Idle or Sleep mode. Further, device can be woken up from these low power modes upon switch press.
