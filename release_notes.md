...
## Harmony 3 peripheral library application examples for PIC32MZ EF family v3.6.1
...
|:-----------------:|:-------------------:|
| [PIC32MZ Embedded Connectivity with FPU (EF) Starter Kit](https://www.microchip.com/DevelopmentTools/ProductDetails/dm320007) | 34 |
...
## Harmony 3 peripheral library application examples for PIC32MZ EF family v3.6.0
...
## Harmony 3 peripheral library application examples for PIC32MZ EF family v3.5.0
...
## Harmony 3 peripheral library application examples for PIC32MZ EF family  v3.1.1
...
## Harmony 3 peripheral library application examples for PIC32MZ EF family  v3.0.1
